package com.mandiriexel.fasttransfer.ui.qrcodedetail
...
import kotlinx.android.synthetic.main.activity_qrcode_detail.*
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        uiSetuju.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
                val uri = Uri.parse("mandiri://qrcodepassword")
                val intent = Intent(Intent.ACTION_VIEW, uri)
                startActivity(intent)
            }
        })
        uiBatal.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View?) {
